...
class cfgvehicles
{
	...
	class Maiar_Kit_base;
	class Maiar_NightStalkers_SafeZone: Maiar_Kit_base
	{
		scope=2;
		displayName="NightStalkers Loadout";
		descriptionShort="This has MVS Vest, SOCOM Pants, Pilots Jacket, Battle Belt, Warrior Helmet, and all attachments for these items(Pouches). Opening this item places all items at your feet.11/6/2021";
		KitItems[]= 
		{
