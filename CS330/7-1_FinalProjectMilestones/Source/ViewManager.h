...
public:
	...
	// Scroll wheel position callback for scroll wheel interation with the 3D scene
	static void Mouse_Scroll_Wheel_Callback(GLFWwindow* window, double xScrollPos, double yScrollPos);
