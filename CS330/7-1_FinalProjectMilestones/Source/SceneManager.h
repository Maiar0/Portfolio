...
private:
	...
	void SetShaderTexture(
		std::string textureTag);//,std::string shaderSet = g_TextureValueName);

	//Texture blending
	void SetShaderTextureBlending(std::string texture1, std::string texture2, float blendFactor = 0.5f);
